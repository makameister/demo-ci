        ...
        stage('Push to Nexus') {
            steps {
                sh '''
                    ...
                    curl -v -X PUT -H "Content-Type: application/zip" --upload-file release.tar.gz -u "jenkins:jenkins" http://nexus:8081/repository/php/packages/upload/maka/demo-ci/0.0.5/release.tar.gz
                '''
