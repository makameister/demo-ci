        ...
        stage('Push to Nexus') {
            steps {
                sh '''
                    ...
                    curl --verbose -X PUT --header "application/tar+gzip" --upload-file release.tar.gz -u 'jenkins:jenkins' http://nexus:8081/repository/php/packages/upload/maka/demo-ci/0.0.3
                '''
